...
class BackyardFlyer(Drone):
    ...
    def state_callback(self):
        """
        This triggers when `MsgID.STATE` is received and 
        self.armed and self.guided contain new data # super
        """
    ...
    def calculate_box(self, target_side=1.0, target_altitude=3.0):
        ...
        target_altitude = 3.0
        target_side = 3.0
        waypoints = [[target_side, 0, -target_altitude, 0], 
                     [target_side, target_side, -target_altitude, 0],
                     [0, target_side, -target_altitude, 0],
                     [0, 0, -target_altitude, 0]]
